...
def circuit_drawer(circuit,
    ...
    Args:
        ...
        ax (Axes): The existing matplotlib axes to be used if 'mpl' is chosen for
            output. Default is None, and a new matplotlib figure is created.
    Returns:
...
def _matplotlib_circuit_drawer(circuit,
    ...
    qcd = _matplotlib.MatplotlibDrawer(qregs, cregs, ops, scale=scale, style=style,
                                       plot_barriers=plot_barriers,
                                       reverse_bits=reverse_bits, ax=ax)
